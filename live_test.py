...
LABELS = ["bathroom", "bedrom","dinningroom","garden","kitchen","livingroom","studio","toilet"] # UPDATE ME!!!!
...
def live_test(model_path):
	...
	while (live_data):
		...
		#orig_frame = cv2.imread('/home/sylvia/Descargas/casa/bathroom/bathroom2.jpg')
		...
		cv2.putText(orig_frame, res, (5, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3, cv2.LINE_AA)
